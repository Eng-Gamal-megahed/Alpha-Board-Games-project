/********************************************************************************
** Form generated from reading UI file 'inverse.ui'
**
...
public:
    ...
    void setupUi(QMainWindow *Inverse)
    {
        if (Inverse->objectName().isEmpty())
            Inverse->setObjectName("Inverse");
        Inverse->resize(800, 600);
        Inverse->setStyleSheet(QString::fromUtf8("background-color: #021a1a;"));
        centralwidget = new QWidget(Inverse);
        centralwidget->setObjectName("centralwidget");
        gridLayout_3 = new QGridLayout(centralwidget);
        gridLayout_3->setObjectName("gridLayout_3");
        horizontalSpacer_9 = new QSpacerItem(99, 20, QSizePolicy::Policy::Expanding, QSizePolicy::Policy::Minimum);
...
"padding: 16px;"));
        ...
        horizontalSpacer_8 = new QSpacerItem(99, 20, QSizePolicy::Policy::Expanding, QSizePolicy::Policy::Minimum);
        ...
        Inverse->setCentralWidget(centralwidget);
        menubar = new QMenuBar(Inverse);
        menubar->setObjectName("menubar");
        menubar->setGeometry(QRect(0, 0, 800, 25));
        Inverse->setMenuBar(menubar);
        statusbar = new QStatusBar(Inverse);
        statusbar->setObjectName("statusbar");
        Inverse->setStatusBar(statusbar);

        retranslateUi(Inverse);

        QMetaObject::connectSlotsByName(Inverse);
    } // setupUi

    void retranslateUi(QMainWindow *Inverse)
    {
        Inverse->setWindowTitle(QCoreApplication::translate("Inverse", "MainWindow", nullptr));
        Player1_name->setText(QCoreApplication::translate("Inverse", "Player1", nullptr));
        Player2_name->setText(QCoreApplication::translate("Inverse", "Player2", nullptr));
        label->setText(QCoreApplication::translate("Inverse", "Score", nullptr));
        p1_score->setText(QCoreApplication::translate("Inverse", "0", nullptr));
        p2_score->setText(QCoreApplication::translate("Inverse", "0", nullptr));
        ...
        Back->setText(QCoreApplication::translate("Inverse", "Back", nullptr));
        label_4->setText(QCoreApplication::translate("Inverse", "Inverse Tic-Tac-Toe", nullptr));
        Clear->setText(QCoreApplication::translate("Inverse", "Clear", nullptr));
    } // retranslateUi

};

namespace Ui {
    class Inverse: public Ui_Inverse {};
} // namespace Ui
