/********************************************************************************
** Form generated from reading UI file 'fourxfour.ui'
**
...
#ifndef UI_FOURXFOUR_H
#define UI_FOURXFOUR_H
...
public:
    ...
    void setupUi(QMainWindow *FourXFour)
    {
        if (FourXFour->objectName().isEmpty())
            FourXFour->setObjectName("FourXFour");
        FourXFour->resize(844, 702);
        FourXFour->setStyleSheet(QString::fromUtf8("background-color: #021a1a;"));
        centralwidget = new QWidget(FourXFour);
        centralwidget->setObjectName("centralwidget");
        gridLayout_3 = new QGridLayout(centralwidget);
        gridLayout_3->setObjectName("gridLayout_3");
        horizontalSpacer_8 = new QSpacerItem(139, 20, QSizePolicy::Policy::Expanding, QSizePolicy::Policy::Minimum);
...
""));
        ...
        cell_00->setStyleSheet(QString::fromUtf8("background-color: rgb(2, 26, 26);color: red ; font-size: 28pt; font-weight: bold;"));
        ...
        cell_01->setStyleSheet(QString::fromUtf8("background-color: rgb(2, 26, 26);color: blue ; font-size: 28pt; font-weight: bold;"));
        ...
        cell_02->setStyleSheet(QString::fromUtf8("background-color: rgb(2, 26, 26);color: red ; font-size: 28pt; font-weight: bold;"));
        ...
        cell_03->setStyleSheet(QString::fromUtf8("background-color: rgb(2, 26, 26);color: blue ; font-size: 28pt; font-weight: bold;"));

        horizontalLayout_3->addWidget(cell_03);
...
""));
        ...
        cell_30->setStyleSheet(QString::fromUtf8("background-color: rgb(2, 26, 26);color: blue ; font-size: 28pt; font-weight: bold;"));

        horizontalLayout_2->addWidget(cell_30);
        ...
        cell_31->setStyleSheet(QString::fromUtf8("background-color: rgb(2, 26, 26);color: red ; font-size: 28pt; font-weight: bold;"));

        horizontalLayout_2->addWidget(cell_31);
        ...
        cell_32->setStyleSheet(QString::fromUtf8("background-color: rgb(2, 26, 26);color: blue ; font-size: 28pt; font-weight: bold;"));

        horizontalLayout_2->addWidget(cell_32);
        ...
        cell_33->setStyleSheet(QString::fromUtf8("background-color: rgb(2, 26, 26);color: red ; font-size: 28pt; font-weight: bold;"));

        horizontalLayout_2->addWidget(cell_33);
        ...
        Back_4 = new QPushButton(frame);
        Back_4->setObjectName("Back_4");
        Back_4->setMinimumSize(QSize(0, 40));
...
""));
        ...
        comboBox->setMinimumSize(QSize(75, 40));
        comboBox->setMaximumSize(QSize(16777215, 40));
        comboBox->setStyleSheet(QString::fromUtf8("color: 14213d;\n"
"background-color: #021a1a;\n"
"border-radius: 10px;  \n"
"font-size : 15pt;\n"
"padding: 10px;"));
        ...
        horizontalSpacer_9 = new QSpacerItem(138, 20, QSizePolicy::Policy::Expanding, QSizePolicy::Policy::Minimum);

        gridLayout_3->addItem(horizontalSpacer_9, 2, 4, 1, 1);
        ...
        FourXFour->setCentralWidget(centralwidget);
        menubar = new QMenuBar(FourXFour);
        menubar->setObjectName("menubar");
        menubar->setGeometry(QRect(0, 0, 844, 25));
        FourXFour->setMenuBar(menubar);
        statusbar = new QStatusBar(FourXFour);
        statusbar->setObjectName("statusbar");
        FourXFour->setStatusBar(statusbar);

        retranslateUi(FourXFour);

        QMetaObject::connectSlotsByName(FourXFour);
    } // setupUi

    void retranslateUi(QMainWindow *FourXFour)
    {
        FourXFour->setWindowTitle(QCoreApplication::translate("FourXFour", "MainWindow", nullptr));
        Back->setText(QCoreApplication::translate("FourXFour", "Back", nullptr));
        label_4->setText(QCoreApplication::translate("FourXFour", "4 x 4 Tic-Tac-Toe", nullptr));
        Clear->setText(QCoreApplication::translate("FourXFour", "Clear", nullptr));
        Player1_name->setText(QCoreApplication::translate("FourXFour", "Player1", nullptr));
        Player2_name->setText(QCoreApplication::translate("FourXFour", "Player2", nullptr));
        label->setText(QCoreApplication::translate("FourXFour", "Score", nullptr));
        p1_score->setText(QCoreApplication::translate("FourXFour", "0", nullptr));
        p2_score->setText(QCoreApplication::translate("FourXFour", "0", nullptr));
        cell_00->setText(QCoreApplication::translate("FourXFour", "O", nullptr));
        cell_01->setText(QCoreApplication::translate("FourXFour", "X", nullptr));
        cell_02->setText(QCoreApplication::translate("FourXFour", "O", nullptr));
        cell_03->setText(QCoreApplication::translate("FourXFour", "X", nullptr));
        ...
        cell_30->setText(QCoreApplication::translate("FourXFour", "X", nullptr));
        cell_31->setText(QCoreApplication::translate("FourXFour", "O", nullptr));
        cell_32->setText(QCoreApplication::translate("FourXFour", "X", nullptr));
        cell_33->setText(QCoreApplication::translate("FourXFour", "O", nullptr));
        Back_4->setText(QCoreApplication::translate("FourXFour", "Direction", nullptr));
        comboBox->setItemText(0, QCoreApplication::translate("FourXFour", "Down ", nullptr));
        comboBox->setItemText(1, QCoreApplication::translate("FourXFour", "UP", nullptr));
        comboBox->setItemText(2, QCoreApplication::translate("FourXFour", "Right", nullptr));
        comboBox->setItemText(3, QCoreApplication::translate("FourXFour", "Left", nullptr));
...
namespace Ui {
    class FourXFour: public Ui_FourXFour {};
} // namespace Ui

QT_END_NAMESPACE

#endif // UI_FOURXFOUR_H
