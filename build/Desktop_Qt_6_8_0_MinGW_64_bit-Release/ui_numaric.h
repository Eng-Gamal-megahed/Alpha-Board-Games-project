/********************************************************************************
** Form generated from reading UI file 'numaric.ui'
**
...
public:
    ...
    void setupUi(QMainWindow *Numaric)
    {
        if (Numaric->objectName().isEmpty())
            Numaric->setObjectName("Numaric");
        Numaric->resize(800, 680);
        Numaric->setStyleSheet(QString::fromUtf8("background-color: #021a1a;"));
        centralwidget = new QWidget(Numaric);
        centralwidget->setObjectName("centralwidget");
        gridLayout_3 = new QGridLayout(centralwidget);
        gridLayout_3->setObjectName("gridLayout_3");
        horizontalSpacer_9 = new QSpacerItem(90, 20, QSizePolicy::Policy::Expanding, QSizePolicy::Policy::Minimum);

        gridLayout_3->addItem(horizontalSpacer_9, 1, 4, 1, 1);

        horizontalSpacer_8 = new QSpacerItem(91, 20, QSizePolicy::Policy::Expanding, QSizePolicy::Policy::Minimum);
...
""));
        ...
        Back_2 = new QPushButton(frame);
        Back_2->setObjectName("Back_2");
        Back_2->setMinimumSize(QSize(0, 30));
        Back_2->setMaximumSize(QSize(150, 40));
        Back_2->setStyleSheet(QString::fromUtf8("color: #FFFFFF;\n"
"background-color: #021a1a;\n"
"border-radius: 10px;  \n"
"font-size : 16pt;\n"
"font-weight: bold;\n"
""));
        ...
        horizontalLayout_9->addWidget(Back_2);

        enabled_nubers = new QComboBox(frame);
        enabled_nubers->setObjectName("enabled_nubers");
        enabled_nubers->setMinimumSize(QSize(0, 40));
        enabled_nubers->setMaximumSize(QSize(16777215, 40));
        enabled_nubers->setStyleSheet(QString::fromUtf8("color: 14213d;\n"
"background-color: #021a1a;\n"
"border-radius: 10px;  \n"
"font-size : 15pt;\n"
"padding: 10px;"));

        horizontalLayout_9->addWidget(enabled_nubers);
...
"padding: 16px;"));
        ...
        gridLayout_3->addItem(verticalSpacer_6, 4, 1, 1, 1);

        Numaric->setCentralWidget(centralwidget);
        menubar = new QMenuBar(Numaric);
        menubar->setObjectName("menubar");
        menubar->setGeometry(QRect(0, 0, 800, 25));
        Numaric->setMenuBar(menubar);
        statusbar = new QStatusBar(Numaric);
        statusbar->setObjectName("statusbar");
        Numaric->setStatusBar(statusbar);

        retranslateUi(Numaric);

        QMetaObject::connectSlotsByName(Numaric);
    } // setupUi

    void retranslateUi(QMainWindow *Numaric)
    {
        Numaric->setWindowTitle(QCoreApplication::translate("Numaric", "MainWindow", nullptr));
        Player1_name->setText(QCoreApplication::translate("Numaric", "Player1", nullptr));
        Player2_name->setText(QCoreApplication::translate("Numaric", "Player2", nullptr));
        label->setText(QCoreApplication::translate("Numaric", "Score", nullptr));
        p1_score->setText(QCoreApplication::translate("Numaric", "0", nullptr));
        p2_score->setText(QCoreApplication::translate("Numaric", "0", nullptr));
        ...
        Back_2->setText(QCoreApplication::translate("Numaric", "Number ", nullptr));
        Back->setText(QCoreApplication::translate("Numaric", "Back", nullptr));
        label_4->setText(QCoreApplication::translate("Numaric", "Numaric Tic-Tac-Toe", nullptr));
        Clear->setText(QCoreApplication::translate("Numaric", "Clear", nullptr));
    } // retranslateUi

};

namespace Ui {
    class Numaric: public Ui_Numaric {};
} // namespace Ui
